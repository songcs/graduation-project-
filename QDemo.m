...
robot=struct('alpha',0.5,'gamma',0.5,'Qtable',zeros(400,4),'best',[],'state',[1,1]);%alpha（学习效率） gamma(折扣因子) 学习参数  best 最优路径 state 状态 Qtable存储5*5每个状态Q值
robot=Qlearning(robot,task,Rew,500);
